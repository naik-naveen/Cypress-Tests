describe('Receipt feature Test', () => {
    ...
    it('when user click on receipts link,should navigate to receipts page successfully ', () => {
        ...
        cy.get('a[href="/receipts/detailedReport"]').should('exist')
        cy.get('a[href="/receipts/revenueSharingReport"]').should('exist')
        cy.get('a[href="/receipts/receiptsSummaryReport"]').should('exist')
    })
    it('when user click on receipts add should navigate to receipts/add page successfully ', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/add"]').click()
    ...
    it('when user click on Receipt search should navigate to Receipt manage page successfully ', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/manage"]').click()
    ...
    it('when user click on Detailed report link should navigate to detailedReport page', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/detailedReport"]').click({force: true})
    ...
    it('when user click on Revenue Sharing Report link should navigate to revenueSharingReport page', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/revenueSharingReport"]').click({force: true})
    ...
    it('when user click on Summary Report link should navigate to receiptsSummaryReport page', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/receiptsSummaryReport"]').click({force: true})
    ...
    it('Verify back button in REcipts feature', () => {
        cy.visit('/receipts')
        cy.get('a[href="/receipts/add"]').click({force: true})
