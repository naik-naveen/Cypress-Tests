...
describe('accounting feature Test', () => {
  ...
  it('should navigate to accounting page successfully ', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.url().should('include', '/accounting')
    cy.get('li:contains(Action Links)').should('be.visible')
    cy.get('span:contains(Chart of Accounts)').should('be.visible').siblings().children().children('a[href="/accounting/coa"]').should('exist')
    cy.get('span:contains(Voucher)').should('be.visible').siblings().children().children('a[href="/accounting/manageVoucher"]').should('exist')
    cy.get('span:contains(Voucher)').should('be.visible').siblings().children().next().children('a[href="/accounting/addVoucher"]').should('exist')
  ...
  it('when user click on COA manage link should navigate to coa page', () => {
    cy.visit('/accounting')
     cy.wait(6000)
    cy.get('a[href="/accounting/coa"]').click()
    cy.url().should('include', '/accounting/coa')
    cy.get('span:contains(Chart Of Accounts)').should('be.visible').should('exist')
    cy.get('i[class="fa fa-angle-double-left"]').should('exist')
    cy.get('i[class="fa fa-close"]').should('exist')
    cy.get('strong:contains(Chart Of Accounts)').should('be.visible').parent().next().children('button[title="Collapse All"]').should('exist').next('button[title="Expand All"]').should('exist')
    cy.get('span:contains(Capital)').should('be.visible').prev().children('i[class="fa fa-chevron-right fs-4 btn btn-xs py-7"]').should('exist')
  })
  ...
  it('when user click on manage Voucher link should navigate to manage Voucher page', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.get('a[href="/accounting/manageVoucher"]').click()
  ...
  it('when user click on add Voucher link should navigate to voucher add page', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.get('a[href="/accounting/addVoucher"]').click()
  ...
  it('When user click on category wise ExpenseReport ,should navigate to category wise Expense Report page and should able to download report', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.get('a[href="/accounting/categorywiseExpenseReport"]').click()
    cy.url().should('include', '/categorywiseExpenseReport')
    cy.get('h4').should('contain.text', 'AccountingCategorywise Expense Report')
    cy.get('i[class="fa fa-print"]').should('exist').click()
    cy.get('i[class="fa fa-file-pdf-o"]').should('exist')
    // cy.verifyDownload('category wise Expense Report.pdf', { contains: true })
  })
  it('When user click on Datewise Expense Report  ,should navigate to Datewise Expense Report  page and should able to download report', () => {
    ...
    cy.wait(6000)
    cy.url().should('include', '/accounting')
    cy.get('a[href="/accounting/datewiseExpenseReport"]').click()
  ...
  it('When user click on Yearwise Expense Report ,should navigate to Yearwise Expense Report page and should able to download report', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.get('a[href="/accounting/yearwiseExpenseReport"]').click()
    ...
    cy.click_Back_Button()
    cy.url().should('eq', Cypress.config().baseUrl + '/accounting')
    //cy.verifyDownload('Yearwise Expense Report.pdf', { contains: true })
  })
  ...
  /* it('when user click on disable , selected voucher should get disabled', () => {
     cy.visit('/accounting')
     cy.get('a[href="/accounting/manageVoucher"]').click()
     cy.get('input[placeholder="Search"]').type(Cypress.env('voucher')).parent().next().children('i[class="fa fa-search"]').click()
     cy.contains('td', 'BTL/10').siblings('td').last().find('td:contains(Disable )').click()
    // cy.get('td:contains(Disable )').click()
   })
   it('when user click on Enable , selected voucher should get Enabled', () => {
     cy.visit('/accounting')
     cy.get('a[href="/accounting/manageVoucher"]').click()
     cy.get('input[placeholder="Search"]').type(Cypress.env('voucher')).parent().next().children('i[class="fa fa-search"]').click()
     cy.contains('td', 'BTL/10').siblings('td').last().find('td:contains(Enable )').click()
     //cy.get('td:contains(Enable )').click()
   })*/
  ...
  it('Verify back button in Voucher feature', () => {
    cy.visit('/accounting')
    cy.wait(6000)
    cy.get('a[href="/accounting/addVoucher"]').click({force: true})
    cy.url().should('eq', Cypress.config().baseUrl + '/accounting/addVoucher')
    cy.click_Back_Button()
    cy.url().should('eq', Cypress.config().baseUrl + '/accounting')
    cy.get('a[href="/accounting/manageVoucher"]').click({force: true})
